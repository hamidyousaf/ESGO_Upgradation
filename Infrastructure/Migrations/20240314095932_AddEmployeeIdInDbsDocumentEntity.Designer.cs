...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240314095932_AddEmployeeIdInDbsDocumentEntity")]
    partial class AddEmployeeIdInDbsDocumentEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.DbsDocument", b =>
                {
                    b.HasOne("Domain.Entities.DocumentType", "DocumentType")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.DbsDocument", "DocumentTypeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.DbsDocument", "EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
